  ...
  <div class="app-body">
    ...
    <!-- Main content -->
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Template BAST Customer</li>
        <!-- Breadcrumb Menu-->
      </ol>
      <!-- /.conainer-fluid -->
      ...
      <div class="card-header">
        <h3 class="panel-title pull-left">
         Template BAST Customer
        </h3>
   <!--      <a href="<?php echo site_url('template_bastcustomer/create');?>" class="btn btn-sm btn-success pull-right"><i class="fa fa-plus"></i> Create</a>
 -->       </div>
              ...
              <tr>
                ...
                <td class="text-center">
                  ...
                  <a href="'.site_url('c_templateBAST/export_pdfCUST/'.trim(base64_encode($row->id),'=').'').'" class="btn btn-primary btn-sm" title="Generate PDF customer"><i class="fa fa-file-pdf-o"></i></a>
                   <a href="'.site_url('c_templateBAST/export_pdfVEND/'.trim(base64_encode($row->id),'=').'').'" class="btn btn-primary btn-sm" title="Generate PDF vendor"><i class="fa fa-file-pdf-o"></i></a>
                </td>
              </tr>';
            }
          }
