...
<main class="main">
   <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Edit Template BAST Customer</li>
   </ol>
   <div class="container-fluid">
      ...
      <a href="<?php echo site_url('c_templateBAST/viewTemplateBAST');?>" class="btn btn-sm btn-success pull-right"><i class="fa fa-reply"></i> Kembali</a>
         </div>
         <ul class="nav navbar-right panel_toolbox">
         </ul>
         <div class="card-body">
      <form class="form-horizontal" method="post" action="<?php echo site_url('c_templateBAST/update');?>">
      <input type="hidden" class="form-control" id="pesanan_id" name="pesanan_id" value="<?php echo $pesanan_id;?>" placeholder="Input nomor surat" readonly>
        ...
        <label class="control-label col-sm-10" for="nama_customer">NAMA CUSTOMER</label>
        <div class="col-sm-10"> 
          <input type="text" class="form-control" id="nama_customer" name="nama_customer" value="<?php echo $nama_customer;?>" placeholder="Input nama customer" required>
        ...
        <div class="col-sm-10"> 
          <input type="text" class="form-control" id="nama_vendor" name="nama_vendor" value="<?php echo $nama_vendor;?>" placeholder="Input nama customer" required>
      
        </div>
        </div>
       <!--  <div class="form-group">
        <label class="control-label col-sm-10" for="tgl_bast">TANGGAL SERAH TERIMA</label>
        <div class="col-sm-10"> 
          <input type="date" class="form-control" id="tgl_bast" name="tgl_bast" value="<?php echo $tgl_bast;?>" placeholder="Input tanggal serah terima" required>
        </div>
        </div> -->
        <div class="form-group"> 
