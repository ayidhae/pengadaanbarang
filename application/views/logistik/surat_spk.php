...
<h4 align="center">No.{nomor_spk}</h4>
<br/>
<p>Dengan berdasarkan hasil negosiasi harga tanggal {tgl_negoisasi_spk} antara PT. Bhakti Unggul Teknovasi dengan {nama_vendor} tentang Pengadaan {nama_pengadaan},maka kami yang bertanda tangan dibawah ini :</p>
<table width="100%">
   <tbody>
      <tr>
         <td width="20%">
...
<ul>
   <li><strong>a)</strong> Jangka waktu pelaksanaan pekerjaan pengadaan barang pada butir 1 (satu) di atas adalah selama {jangka_waktu} ({terbilang_jangka_waktu}) hari kalender.</li>
...
<table width="100%">
   <tbody>
      <tr>
         <td width="30%">&nbsp;</td>
		 <td width="40%"></td>
		 <td width="30%">Bandung, {tgl_spk}</td>
      </tr>
	  <tr>
